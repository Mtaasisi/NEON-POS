...
/**
 * Apply inventory_items table migration
 */
...
console.log('🚀 Applying inventory_items table migration...');
console.log(`📊 Database: ${DATABASE_URL.substring(0, 50)}...`);

const sql = neon(DATABASE_URL);

try {
  const migrationSQL = readFileSync('migrations/20251226_create_inventory_items_table.sql', 'utf8');
  ...
  console.log('✅ inventory_items table should now exist');

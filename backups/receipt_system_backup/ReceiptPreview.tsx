...
const ReceiptPreview: React.FC<ReceiptPreviewProps> = ({ settings, businessInfo }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4">
      <div className="text-xs text-gray-500 mb-3 text-center border-b border-gray-100 pb-2">
        <div className="flex items-center justify-between">
          ...
          {isA4 && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono min-w-[24px]">{Math.round(zoomLevel * 100)}%</span>
              <button

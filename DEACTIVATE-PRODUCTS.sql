-- ================================================================================
-- SOFT DELETE: Deactivate products instead of deleting them
-- ================================================================================
-- This keeps sales history intact while hiding products from active lists
-- ================================================================================
...
SELECT 
    '✅ PRODUCTS DEACTIVATED' as status,
    COUNT(*) as count
FROM lats_products
...
SELECT '✅ Products deactivated. They won''t show in active lists but sales history is preserved.' as result;

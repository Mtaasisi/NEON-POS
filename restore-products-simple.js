...
async function restoreProducts() {
  ...
  try {
    ...
    // 2. Restore Products (mapping to existing schema)
    console.log('\n📱 Restoring products...');
      ...
      try {
        await client.query(`
          INSERT INTO lats_products (
            ...
            min_stock_level, brand, warranty_period,
            supplier_id, is_active, tags, branch_id,
            created_at, updated_at, unit_price, condition
          ) VALUES (
        ...
        `, [
          ...
          product.reorder_level || 0, // maps to min_stock_level
          product.brand,
          ...
          product.selling_price || 0, // unit_price = selling_price

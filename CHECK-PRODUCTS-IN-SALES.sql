-- ================================================================================
-- CHECK: Which products are used in sales?
-- ================================================================================

-- Products used in sales
SELECT 
    '📊 PRODUCTS USED IN SALES' as status,
    p.id,
    p.name,
    p.sku,
...
-- Products NOT used in sales (can be safely deleted)
SELECT 
    '✅ PRODUCTS NOT IN SALES (SAFE TO DELETE)' as status,
    p.id,
    p.name,
    p.sku
FROM lats_products p

...
if (!DATABASE_URL) {
  ...
  console.error('💡 Make sure .env.production file exists with DATABASE_URL');
  process.exit(1);
}
...
// Admin user details
const adminEmail = 'care@care.com';
...
async function createAdminUser() {
  try {
    console.log('🔧 Creating admin user: care@care.com\n');
    ...
    if (checkResult.rows.length > 0) {
      ...
      // Update user to ensure admin role and correct password

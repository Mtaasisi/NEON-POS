...
const ConditionalPOS = createSafeLazyComponent(() => import('./features/shared/components/ConditionalPOS'), 'ConditionalPOS');
...
// Tablet & Repair Management
const TabletPOS = lazy(() => import('./features/tablet/pages/TabletPOS'));
const RepairManagementPage = lazy(() => import('./features/repair/pages/RepairManagementPage'));
const RepairAnalyticsPage = lazy(() => import('./features/repair/pages/RepairAnalyticsPage'));
const TechnicianManagementPage = lazy(() => import('./features/repair/pages/TechnicianManagementPage'));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/business" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<DynamicPageLoader />}><BusinessManagementPage /></Suspense></RoleProtectedRoute>} />

        {/* Tablet & Repair Management */}
        <Route path="/tablet/pos" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><Suspense fallback={<DynamicPageLoader />}><TabletPOS /></Suspense></RoleProtectedRoute>} />
        <Route path="/repair" element={<RoleProtectedRoute allowedRoles={['admin', 'technician']}><Suspense fallback={<DynamicPageLoader />}><RepairManagementPage /></Suspense></RoleProtectedRoute>} />
        <Route path="/repair/analytics" element={<RoleProtectedRoute allowedRoles={['admin', 'technician']}><Suspense fallback={<DynamicPageLoader />}><RepairAnalyticsPage /></Suspense></RoleProtectedRoute>} />
        <Route path="/repair/technicians" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<DynamicPageLoader />}><TechnicianManagementPage /></Suspense></RoleProtectedRoute>} />
        ...
        <Route path="/excel-templates" element={
          ...
          {/* POS Route - Device-aware routing */}

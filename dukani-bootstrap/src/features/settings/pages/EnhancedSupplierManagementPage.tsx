        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col max-h-[95vh]">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            <div className="space-y-6">
              ...
              {/* Search & Filters */}
              <GlassCard className="bg-white rounded-2xl border-2 border-gray-200 p-6 shadow-sm mb-6">
              ...
              {/* Suppliers Grid/List */}
              <GlassCard className="bg-white rounded-2xl border-2 border-gray-200 shadow-sm overflow-hidden">

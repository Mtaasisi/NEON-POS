...
import { Layers, Plus, Trash2, Package, Move, Check, DollarSign, ChevronUp, Minus, Hash } from 'lucide-react';
          ...
          <div className="p-6 space-y-4 max-w-5xl mx-auto">
            {variants.length === 0 ? (
              ...
              variants.map((variant, index) => {
                ...
                const isComplete = variant.name && variant.price > 0 && (variant.stockQuantity || 0) > 0;

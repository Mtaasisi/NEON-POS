  ...
  try {
    ...
    if (data) {
      const processedCustomer = {
        ...
        // Fields that don't exist in DB - set defaults
        profileImage: null,
        whatsapp: data.phone, // Use phone as fallback
        ...
        // Fields that don't exist - set defaults
        createdBy: null,
        lastPurchaseDate: null,
        totalPurchases: 0,
        birthday: null,
        referredBy: null,
        // Call analytics fields - not in DB, set defaults
        totalCalls: 0,

-- FIX: Remove low_stock_threshold column reference from stock transfer functions
-- This fixes the error: column "low_stock_threshold" of relation "lats_product_variants" does not exist
...
-- Function 1: Find or Create Variant at Branch (FIXED - removed low_stock_threshold)
...
BEGIN
  ...
  BEGIN
    -- FIXED: Removed low_stock_threshold from INSERT
...
DO $$
BEGIN
  RAISE NOTICE '✅ Fixed! low_stock_threshold references removed from functions.';
  RAISE NOTICE '✅ Run this SQL in your Neon database console to apply the fix.';
END $$;

...
/**
 * Final script to fix the suppliers issue
 * This creates real suppliers using only the columns that actually exist
 */
      ...
      try {
        ...
        const result = await sql`
          INSERT INTO lats_suppliers (
            ...
            is_active, is_trade_in_customer, notes, created_at, updated_at
          ) VALUES (

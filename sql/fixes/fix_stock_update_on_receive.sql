-- =====================================================
-- FIX: Update stock quantity when receiving from PO
-- =====================================================
-- This fixes the issue where stock wasn't being updated
-- when receiving products from purchase orders
...
'Completes the receive process for a purchase order by creating inventory items, updating variant stock quantities, creating stock movement records, updating product supplier_id, and updating the order status to received';

-- Also ensure the lats_stock_movements table exists
...
DO $$
BEGIN
  RAISE NOTICE '✅ Stock update fix applied successfully!';
  RAISE NOTICE '📦 The function now:';
  RAISE NOTICE '   1. Updates variant quantity when receiving';
  RAISE NOTICE '   2. Creates stock movement records';
  RAISE NOTICE '   3. Maintains proper stock tracking';
END $$;

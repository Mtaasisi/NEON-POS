...
BEGIN
  ...
  ELSE
    RAISE NOTICE '⏭️  parent_variant_id column already exists';
  END IF;
  ...
  ELSE
    RAISE NOTICE '⏭️  is_parent column already exists';
  END IF;
  ...
  ELSE
    RAISE NOTICE '⏭️  variant_type column already exists';
  END IF;
END $$;
...
BEGIN
  ...
  RAISE NOTICE '✅ Updated % existing IMEI variants', v_updated_count;
END $$;
...
BEGIN
  ...
  RAISE NOTICE '✅ Documentation added';
END $$;

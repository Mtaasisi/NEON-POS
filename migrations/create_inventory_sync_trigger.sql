...
-- =====================================================
-- This trigger automatically syncs variant quantities with inventory_items count
-- Solves the issue where received items don't show in inventory
...
-- =====================================================
-- INITIAL SYNC - Run once to fix existing data
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'Initial sync complete. Updated % variants.', v_updated;
END $$;

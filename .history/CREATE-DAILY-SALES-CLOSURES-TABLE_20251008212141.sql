-- =============================================================================
-- CREATE DAILY SALES CLOSURES TABLE (NEON DATABASE)
-- =============================================================================
-- This table tracks daily sales closures for the POS system
-- Used to record when a day's sales are closed and by whom
-- 
-- ⚠️ Note: This version is adapted for Neon Database
--    - No auth.users foreign key reference
--    - Simplified RLS policies (permissive by default)

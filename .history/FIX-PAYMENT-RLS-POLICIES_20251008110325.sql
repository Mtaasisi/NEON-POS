...
-- Policy 4: Allow service role to do everything (for RPC functions)
...
GRANT ALL ON purchase_order_payments TO service_role;
...
BEGIN 
  ...
  RAISE NOTICE '   4. Allow service role full access';
  RAISE NOTICE '';

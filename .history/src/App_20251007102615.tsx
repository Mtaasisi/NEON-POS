...
function App() {
  ...
  const [showDiagnostic, setShowDiagnostic] = useState(false); // Show diagnostic with Ctrl+Shift+D

  // Show diagnostic on Ctrl+Shift+D
  useEffect(() => {
      ...
      <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <ThemeProvider>
          <AuthProvider>
            ...
            {/* Debug component - moved inside AuthProvider */}
            <UserDebug />
          </AuthProvider>
        </ThemeProvider>
      </BrowserRouter>

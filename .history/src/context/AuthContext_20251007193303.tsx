...
export const useAuth = () => {
  ...
  if (!context) {
    ...
    console.error('This might be an HMR issue - try refreshing the page');
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchAndSetUserProfile = async (user: any) => {
    try {
      ...
      // Fetch from auth_users table (our main user table)
      ...
      console.log(`📊 Profile data by ID:`, profileData, 'Error:', profileError);
      ...
      if (!profileData) {
        // Check if this is admin@pos.com and set admin role
        const isAdmin = user.email === 'admin@pos.com';

...
// The Neon client accepts query strings when called as a function
const executeSql = async (query: string, params: any[] = []): Promise<any> => {
  try {
    // Call the sql function with query string and parameters
    // Neon's sql() function supports both tagged templates and function calls

...
const supabaseProvider = {
  ...
  // Purchase Orders - placeholder implementations
    ...
    try {
      ...
      const { data: purchaseOrder, error: poError } = await supabase
        ...
        .insert({
          ...
          final_amount: totalAmount + (data.taxAmount || 0) + (data.shippingCost || 0) - (data.discountAmount || 0),
          notes: data.notes || '',
      ...
      console.log('✅ Purchase order items created:', items.length);

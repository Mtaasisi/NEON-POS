...
const PurchaseOrdersPage: React.FC = () => {
  ...
  const formatCurrency = (amount: number, currencyCode: string = 'TZS') => {
    ...
    if (currencyCode === 'TZS' || !currencyCode) {
      return `TSh ${amount.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`;
    }
    ...
    try {
      ...
      return `${currencyCode} ${amount.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`;
    }
  };

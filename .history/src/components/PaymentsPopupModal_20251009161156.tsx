...
const PaymentsPopupModal: React.FC<PaymentsPopupModalProps> = ({
  ...
  // Fallback payment methods if context fails
  ...
  // Use fallback if no payment methods loaded after 3 seconds
  ...
  const displayPaymentMethods = useFallback ? fallbackPaymentMethods : (paymentMethods || []);

...
BEGIN
  ...
  LOOP
    ...
    ELSE
      RAISE NOTICE '❌ Table % does not exist, skipping RLS disable', table_name;
    END IF;
  END LOOP;
END $$;
...
BEGIN
  ...
  -- General Settings
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_general_settings') THEN
  ...
  -- Receipt Settings
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_receipt_settings') THEN
  ...
  -- Advanced Settings
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_advanced_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_dynamic_pricing_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_barcode_scanner_settings') THEN
  ...
  -- Delivery Settings
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_delivery_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_search_filter_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_user_permissions_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_loyalty_customer_settings') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'lats_pos_analytics_reporting_settings') THEN

...
-- ============================================
-- 2. CREATE FUNCTION: complete_purchase_order_receive
...
-- ============================================
-- 3. CREATE FUNCTION: mark_po_as_received
...
-- ============================================
-- 4. CREATE FUNCTION: get_received_items_for_po
...
-- ============================================
-- 5. CREATE FUNCTION: get_purchase_order_receive_summary
...
-- ============================================
-- 6. CREATE FUNCTION: process_purchase_order_return
...
-- ============================================
-- 7. CREATE FUNCTION: get_purchase_order_returns

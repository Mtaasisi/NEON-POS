-- ============================================
-- SIMPLIFIED FIX FOR NEON DATABASE
-- No DO blocks - just plain SQL
-- ============================================

-- Step 1: Drop old incorrectly named tables
...
-- Step 2: Create tables with correct lats_pos_ prefix
...
-- Step 5: Add unique constraints (prevents duplicates)
ALTER TABLE lats_pos_general_settings DROP CONSTRAINT IF EXISTS lats_pos_general_settings_user_id_unique;
ALTER TABLE lats_pos_general_settings ADD CONSTRAINT lats_pos_general_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_dynamic_pricing_settings DROP CONSTRAINT IF EXISTS lats_pos_dynamic_pricing_settings_user_id_unique;
ALTER TABLE lats_pos_dynamic_pricing_settings ADD CONSTRAINT lats_pos_dynamic_pricing_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_receipt_settings DROP CONSTRAINT IF EXISTS lats_pos_receipt_settings_user_id_unique;
ALTER TABLE lats_pos_receipt_settings ADD CONSTRAINT lats_pos_receipt_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_barcode_scanner_settings DROP CONSTRAINT IF EXISTS lats_pos_barcode_scanner_settings_user_id_unique;
ALTER TABLE lats_pos_barcode_scanner_settings ADD CONSTRAINT lats_pos_barcode_scanner_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_delivery_settings DROP CONSTRAINT IF EXISTS lats_pos_delivery_settings_user_id_unique;
ALTER TABLE lats_pos_delivery_settings ADD CONSTRAINT lats_pos_delivery_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_search_filter_settings DROP CONSTRAINT IF EXISTS lats_pos_search_filter_settings_user_id_unique;
ALTER TABLE lats_pos_search_filter_settings ADD CONSTRAINT lats_pos_search_filter_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_user_permissions_settings DROP CONSTRAINT IF EXISTS lats_pos_user_permissions_settings_user_id_unique;
ALTER TABLE lats_pos_user_permissions_settings ADD CONSTRAINT lats_pos_user_permissions_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_loyalty_customer_settings DROP CONSTRAINT IF EXISTS lats_pos_loyalty_customer_settings_user_id_unique;
ALTER TABLE lats_pos_loyalty_customer_settings ADD CONSTRAINT lats_pos_loyalty_customer_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_analytics_reporting_settings DROP CONSTRAINT IF EXISTS lats_pos_analytics_reporting_settings_user_id_unique;
ALTER TABLE lats_pos_analytics_reporting_settings ADD CONSTRAINT lats_pos_analytics_reporting_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_notification_settings DROP CONSTRAINT IF EXISTS lats_pos_notification_settings_user_id_unique;
ALTER TABLE lats_pos_notification_settings ADD CONSTRAINT lats_pos_notification_settings_user_id_unique UNIQUE (user_id);

ALTER TABLE lats_pos_advanced_settings DROP CONSTRAINT IF EXISTS lats_pos_advanced_settings_user_id_unique;
ALTER TABLE lats_pos_advanced_settings ADD CONSTRAINT lats_pos_advanced_settings_user_id_unique UNIQUE (user_id);

-- Done!
SELECT '✅ All settings tables created successfully!' as status;
SELECT 'Tables have correct lats_pos_ prefix' as info_1;
SELECT 'RLS disabled, indexes created, unique constraints added' as info_2;
SELECT 'Now refresh your app!' as next_step;

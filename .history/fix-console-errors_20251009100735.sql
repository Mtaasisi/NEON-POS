...
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'devices') THEN
    ...
    EXECUTE 'GRANT ALL ON devices TO anon';
...
GRANT EXECUTE ON FUNCTION get_or_create_user_goal TO anon;
...
GRANT EXECUTE ON FUNCTION get_purchase_order_history TO anon;

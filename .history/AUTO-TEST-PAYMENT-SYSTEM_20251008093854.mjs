...
const DATABASE_URL = 'postgresql://lats_owner:YOUR_PASSWORD@ep-rough-sun-a5x8qj8x.us-east-2.aws.neon.tech/lats?sslmode=require';
...
async function testPaymentSystem() {
  ...
  try {
    ...
    const { rows: productColumns } = await sql`
    ...
    const { rows: variantColumns } = await sql`
      SELECT column_name, data_type 
      FROM information_schema.columns 

...
-- 1. CREATE lats_inventory_adjustments table (REQUIRED!)
-- ============================================
...
-- 2. Ensure lats_inventory_items table exists
-- ============================================
...
-- ============================================
-- 4. CREATE FUNCTION: complete_purchase_order_receive
...
-- ============================================
-- 5. CREATE FUNCTION: mark_po_as_received
...
-- ============================================
-- 6. CREATE FUNCTION: get_received_items_for_po
...
-- ============================================
-- 7. CREATE FUNCTION: get_purchase_order_receive_summary
...
-- ============================================
-- 8. CREATE FUNCTION: process_purchase_order_return
...
-- ============================================
-- 9. CREATE FUNCTION: get_purchase_order_returns

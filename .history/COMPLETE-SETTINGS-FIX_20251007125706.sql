...
-- Note: Neon doesn't use Supabase roles, so no GRANT needed
-- Disabling RLS is sufficient for Neon Database

SELECT '✅ RLS disabled (no GRANT needed in Neon)' as status;

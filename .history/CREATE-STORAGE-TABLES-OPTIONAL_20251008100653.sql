...
-- Grant permissions (Neon-compatible - only grant to roles that exist)
DO $$
BEGIN
  RAISE NOTICE '🔧 DEBUG: Granting permissions on storage tables...';
  ...
  -- Grant to postgres role only if it exists (standard PostgreSQL)

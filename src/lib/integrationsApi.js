 ...
 */
export async function getIntegrationsByType(type) {
    const { data, error } = await supabase
        .from('lats_pos_integrations_settings')
        .select('*')
 ...
 */
export async function getCredentials(integrationName) {
 ...
 * Update integration
 */
export async function updateIntegration(integrationName, updates) {
    const { data, error } = await supabase
        .from('lats_pos_integrations_settings')
        .update({
        ...updates,
 ...
 * Delete integration
 */
export async function deleteIntegration(integrationName) {
 ...
 */
export async function toggleIntegration(integrationName, enabled) {
    const { error } = await supabase
        .from('lats_pos_integrations_settings')
        .update({
        is_enabled: enabled,
 ...
 */
export async function updateIntegrationUsage(integrationName, success) {
    const integration = await getIntegration(integrationName);
    if (!integration)
        return;
    const { error } = await supabase

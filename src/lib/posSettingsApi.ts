...
export interface ReceiptSettings {
  ...
  user_id?: string;
  business_id?: string;
  receipt_template: 'standard' | 'compact' | 'detailed' | 'a4' | 'custom';
...
let cacheRefreshPromise: Promise<any> | null = null;
...
export class POSSettingsAPI {
  ...
  // Get user from Supabase auth (works even without auth schema in database)

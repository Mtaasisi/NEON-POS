...
async function initializeSchema(): Promise<void> {
  ...
  const schema = `
    ...
    CREATE TABLE IF NOT EXISTS lats_products (
      ...
      visible_to_branches TEXT,
      sharing_mode TEXT DEFAULT 'none',
      shelf_id TEXT,
      category TEXT,
      is_customer_portal_visible INTEGER DEFAULT 0,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
      updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
    );
    ...
    -- Customers (main table for app compatibility)
  ...
  // Add ALTER TABLE statements for schema upgrades (existing databases)
  const alterStatements = `
    -- Add missing columns to lats_products
    ALTER TABLE lats_products ADD COLUMN barcode TEXT;
    ALTER TABLE lats_products ADD COLUMN unit_price REAL DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN cost_price REAL DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN stock_quantity INTEGER DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN min_stock_level INTEGER DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN max_stock_level INTEGER DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN is_active INTEGER DEFAULT 1;
    ALTER TABLE lats_products ADD COLUMN image_url TEXT;
    ALTER TABLE lats_products ADD COLUMN brand TEXT;
    ALTER TABLE lats_products ADD COLUMN model TEXT;
    ALTER TABLE lats_products ADD COLUMN warranty_period TEXT;
    ALTER TABLE lats_products ADD COLUMN specification TEXT;
    ALTER TABLE lats_products ADD COLUMN condition TEXT;
    ALTER TABLE lats_products ADD COLUMN selling_price REAL DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN tags TEXT;
    ALTER TABLE lats_products ADD COLUMN total_quantity INTEGER DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN total_value REAL DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN storage_room_id TEXT;
    ALTER TABLE lats_products ADD COLUMN store_shelf_id TEXT;
    ALTER TABLE lats_products ADD COLUMN attributes TEXT;
    ALTER TABLE lats_products ADD COLUMN metadata TEXT;
    ALTER TABLE lats_products ADD COLUMN is_shared INTEGER DEFAULT 0;
    ALTER TABLE lats_products ADD COLUMN visible_to_branches TEXT;
    ALTER TABLE lats_products ADD COLUMN sharing_mode TEXT DEFAULT 'none';
    ALTER TABLE lats_products ADD COLUMN shelf_id TEXT;
    ALTER TABLE lats_products ADD COLUMN category TEXT;
    ALTER TABLE lats_products ADD COLUMN is_customer_portal_visible INTEGER DEFAULT 0;

    -- Add missing columns to lats_product_variants
    ALTER TABLE lats_product_variants ADD COLUMN min_quantity INTEGER DEFAULT 0;
    ALTER TABLE lats_product_variants ADD COLUMN stock_per_branch TEXT;
    ALTER TABLE lats_product_variants ADD COLUMN reserved_quantity INTEGER DEFAULT 0;
    ALTER TABLE lats_product_variants ADD COLUMN reorder_point INTEGER DEFAULT 0;
    ALTER TABLE lats_product_variants ADD COLUMN variant_name TEXT;
    ALTER TABLE lats_product_variants ADD COLUMN variant_attributes TEXT;
    ALTER TABLE lats_product_variants ADD COLUMN is_shared INTEGER DEFAULT 0;
    ALTER TABLE lats_product_variants ADD COLUMN visible_to_branches TEXT;
    ALTER TABLE lats_product_variants ADD COLUMN sharing_mode TEXT DEFAULT 'none';
    ALTER TABLE lats_product_variants ADD COLUMN status TEXT DEFAULT 'active';
  `;

  // Execute ALTER statements (ignore errors for columns that already exist)
  try {
    db.exec(alterStatements);
    console.log('✅ Database schema upgraded');
  } catch (error) {
    // Ignore errors - columns may already exist
    console.log('ℹ️ Schema upgrade completed (some columns may already exist)');
  }

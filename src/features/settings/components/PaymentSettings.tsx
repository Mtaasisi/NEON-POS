    ...
    <div className="space-y-6">
      <GlassCard className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                />
                <span className="text-gray-800 text-sm">Enable</span>
              </label>
            </div>
          ...
          {/* Payment Methods */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Payment Methods</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg bg-white/5 hover:bg-white/10">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded"
                />
                <span className="text-gray-800">Cash Payments</span>
              </label>
              ...
              <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg bg-white/5 hover:bg-white/10">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded"
                />
                <span className="text-gray-800">Card Payments</span>
              </label>
              ...
              <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg bg-white/5 hover:bg-white/10">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded"
                />
                <span className="text-gray-800">Mobile Money</span>
              </label>
            </div>
          </div>
          ...
          {/* Payment Preferences */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Payment Preferences</h4>
            <div className="space-y-3">
              <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg bg-white/5 hover:bg-white/10">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded"
                />
                <span className="text-gray-800">Auto-confirm successful payments</span>
              </label>
              ...
              <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg bg-white/5 hover:bg-white/10">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded"
                />
                <span className="text-gray-800">Require receipt for all transactions</span>
              </label>
            </div>
          </div>
        </div>

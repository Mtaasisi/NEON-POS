...
const WhatsAppTopBar: React.FC<WhatsAppTopBarProps> = ({
  ...
  return (
    <div 
      className="fixed right-0 z-10 bg-gradient-to-b from-slate-50/95 via-white/90 to-white/95 backdrop-blur-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-b-2 border-slate-200/60 rounded-b-3xl transition-[left] duration-500"
      style={{ 

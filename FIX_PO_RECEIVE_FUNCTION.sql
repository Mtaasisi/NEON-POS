-- ============================================================================
-- FIX PURCHASE ORDER RECEIVE FUNCTION - Add branch_id Support
-- ============================================================================
-- This updates the complete_purchase_order_receive function to include
-- branch_id when creating inventory_items
-- ============================================================================
  ...
  BEGIN
    ...
    LOOP
      ...
      IF v_quantity > 0 THEN
        ...
        -- ✅ FIX: Include branch_id from purchase order
        FOR v_i IN 1..v_quantity LOOP
          INSERT INTO inventory_items (
            ...
            metadata,
            purchase_date,
            branch_id,  -- ✅ ADDED: Include branch_id for branch isolation
            created_at,
            updated_at
          ) VALUES (
            ...
            NOW(),
            v_order_record.branch_id,  -- ✅ ADDED: Set branch_id from PO
            NOW(),
            NOW()
          );
...
'Completes the receive process for a purchase order by creating inventory items with branch_id for all ordered items and updating the order status to received';
